...
class Main extends React.PureComponent {
  constructor(props) {
    ...
    this.setGenreList = this.setGenreList.bind(this);
  }

  filterMoviesByGenre(movieArray) {
  ...
  loadMore() {
    this.setState((state) => {
      return {
        visible: state.visible + Quantity.LOAD_MORE,
      };
    });
  }
        ...
        <div className="page-content">
          <section className="catalog">
            ...
            <div className="catalog__movies-list">
              {
                <MovieList
                  movies={this.filterMoviesByGenre(movies)}
                  onCardTitleClick={onCardTitleClick}
                />
              }
            </div>

            {visible < movies.length && <ShowMoreButton loadMore={this.loadMore}/>}
          </section>
